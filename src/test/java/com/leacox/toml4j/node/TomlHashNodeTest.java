...
public class TomlHashNodeTest {
	...
	@Test
	public void testToStringByteExample() throws IOException {
		InputStream exampleStream = getClass().getResourceAsStream("/string_byte_example.toml");

		TomlNode rootNode = new TomlParser().parse(exampleStream);

		String expectedString = "Jos-126";
		expectedString.getBytes("ISO-8859-1");
		assertEquals(expectedString, rootNode.toString());
	}
}
